    ...
    <div class="wrapper">
        ...
        <div class="main p-3">
            <div class="text-center">
                <h3><u>Department Login</u></h3>
                <br><br><br><br><br>
                <h4 class="message">
                    <c:out value="${message}"></c:out>
                </h4>
                <div class="form-container">
                    <form method="post" action="checkdepartmentlogin">
                        <table>
                            <tr>
                                <td><label for="did">Enter Department ID</label></td>
                                <td><input type="text" id="did" name="did" required/></td>
                            </tr>
                            <tr>
