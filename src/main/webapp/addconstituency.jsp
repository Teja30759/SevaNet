    ...
    <div class="wrapper">
        ...
        <div class="main">
            <div class="username">
             ...
             <h3 style="text-align: center;"><u>Add Constituency</u></h3>
            <h4 align="center" style="color: red;">${message}</h4>
            <div class="form-container">
                     <form  action="insertconstituency">
                    <table>
                        <tr>
                            <td><label for="pincode"  data-bs-toggle="tooltip" data-bs-placement="top" title="Enter unique Pin Code">Enter Constituency PinCode</label></td>
                            <td><input type="number" id="pincode" name="pincode" class="form-control" required data-bs-toggle="tooltip" data-bs-placement="top" required title="Enter unique Pin Code" /></td>
                        </tr>
           
                        <tr>
                            <td><label for="constname" data-bs-toggle="tooltip" data-bs-placement="top" title="Provide Constituency Name">Enter Constituency Name</label></td>
                            <td><input type="text" id="constname" name="constname" rows="3" class="form-control" required data-bs-toggle="tooltip" data-bs-placement="top" required title="Provide Constituency Name"></textarea></td>
                        </tr>
